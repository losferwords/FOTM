angular.module('fotm').register.controller("FormController", ["$scope", '$http', '$location', '$timeout', 'formLinkService', 'gettextCatalog', FormController]);
...
angular.module('fotm').register.service('formLinkService', function() {
