...
//ƒоступные способности дл€ каждой роли
...
//‘ункци€ набирает из имеющихс€ способностей дополнительные, которые доступны расе
...
//‘ункци€ выбирает из имеющихс€ рассовых способностей только 4 случайных
...
module.exports = {
    //ѕолучение параметров персонажа при создании
    ...
    //преобразование способностей дл€ клиента
    ...
    //преобразование эффектов дл€ клиента
    ...
    generateAbilitiesArrays: function(role, race) {
        var self = this;
        //Ќабираем базовые скилы дл€ данной роли
